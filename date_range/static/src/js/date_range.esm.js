...
//            {}
//        );
//        console.log("=========date_ranges===========================",this.result)
//        console.log("=========result===========================",this.date_ranges)
...
//                var dateExistingOption = this.OPERATORS.date.forEach(function (option) {
//                    return option.date_range_type === r.date_range_type;
//                });
//                console.log("=========result===========================",this.dateExistingOption)
//                console.log("=========result===========================",this.OPERATORS)
